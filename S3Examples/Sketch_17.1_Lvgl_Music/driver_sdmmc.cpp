...
void sdmmc_init(uint8_t clkPin, uint8_t cmdPin, uint8_t d0Pin, uint8_t d1Pin, uint8_t d2Pin, uint8_t d3Pin) {
  SD_MMC.setPins(clkPin, cmdPin, d0Pin, d1Pin, d2Pin, d3Pin);
