...
- **GT911** touch is read via `bb_captouch` on `Wire` (SDA=8/SCL=4, INT=3, RST=38). The **PCF8575** driving the 3 TTP223 touch pads sits on a separate bus, **Wire1** (SDA=18/SCL=17), address `0x22` — don't confuse the two I2C buses when wiring up new peripherals.
